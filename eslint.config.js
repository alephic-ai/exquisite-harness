...
// Vendored from tools/main (pkgs/eslint-config + create-app-template), trimmed
// for a pure-TypeScript CLI: no Next.js, React, JSX, or Tailwind rules.
// Upstream: https://github.com/alephic-ai/tools/tree/main/pkgs/eslint-config
...
export default [
  ...
  // Git ignore
  includeIgnoreFile(gitIgnorePath, 'alephic-ai/gitignore'),
  ...
  // Default config
  {
    ...
    rules: {
      ...
      'perfectionist/sort-export-attributes': [autofix],
      'perfectionist/sort-exports': [autofix],
      'perfectionist/sort-heritage-clauses': [autofix],
      'perfectionist/sort-import-attributes': [autofix],
  ...
  // Typed rules
  {
    ...
    rules: {
      ...
      '@typescript-eslint/no-useless-default-assignment': [autofix],
